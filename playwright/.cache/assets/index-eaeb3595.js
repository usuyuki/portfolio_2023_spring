...
/* src/lib/components/uiParts/Button/normalButton.svelte generated by Svelte v3.55.1 */
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(p, "class", p_class_value = "text-" + /*textColorVariable*/ ctx[1]);
			attr(div0, "class", div0_class_value = "flex rounded-2xl bg-" + /*bgColorVariable*/ ctx[0] + " px-4 py-2");
			attr(a, "href", /*url*/ ctx[3]);
			attr(div1, "class", "flex itmes-center justify-center");
		},
		m(target, anchor) {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*textColorVariable*/ 2 && p_class_value !== (p_class_value = "text-" + /*textColorVariable*/ ctx[1])) {
				attr(p, "class", p_class_value);
			}

			if (dirty & /*bgColorVariable*/ 1 && div0_class_value !== (div0_class_value = "flex rounded-2xl bg-" + /*bgColorVariable*/ ctx[0] + " px-4 py-2")) {
...
function instance($$self, $$props, $$invalidate) {
	let { bgColorVariable = "pink" } = $$props;
	let { textColorVariable = "black" } = $$props;
	let { title = "ボタン名" } = $$props;
	let { url = "/" } = $$props;

	$$self.$$set = $$props => {
		if ('bgColorVariable' in $$props) $$invalidate(0, bgColorVariable = $$props.bgColorVariable);
		if ('textColorVariable' in $$props) $$invalidate(1, textColorVariable = $$props.textColorVariable);
		if ('title' in $$props) $$invalidate(2, title = $$props.title);
		if ('url' in $$props) $$invalidate(3, url = $$props.url);
	};

	return [bgColorVariable, textColorVariable, title, url];
}

class NormalButton extends SvelteComponent {
	constructor(options) {
		super();
...
register({ _lib_components_uiParts_Button_normalButton_svelte: NormalButton });
//# sourceMappingURL=index-eaeb3595.js.map
